...
public class ExtentReportManager implements ITestListener {
	...
	public void onFinish(ITestContext testContext) {
		 ...
		 * DefaultAuthenticator("mahabarathsankaran@gmail.com","ma#BA543"));
		 * email.setSSLOnConnect(true); email.setFrom("mahabarathsankaran@gmail.com");
		 * //Sender email.setSubject("Test Results");
		 * email.setMsg("Please find Attached Report....");
		 * email.addTo("smahabarath@gmail.com"); //Receiver email.attach(url,
